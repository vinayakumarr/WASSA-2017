...
if __name__ == "__main__":
    ...
    test_df = pd.read_csv('data/testing/anger-ratings-0to1.test.target.txt', sep='\t', header=0)
    ...
    model.load_weights("logs/anger/checkpoint-41.hdf5")
    print("---------------------------------------")
    print(word_id_test)
    testPredict = model.predict(word_id_test)
    np.savetxt("anger.txt", testPredict, fmt="%1.3f")

    #for file in os.listdir("logs/anger/"):
    #   model.load_weights("logs/anger/"+file)
    #   print("---------------------------------------")
    #   print(file)
    #   print("---------------------------------------")
    #   testPredict = model.predict(word_id_test)
