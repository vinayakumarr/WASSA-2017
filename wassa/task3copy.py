...
if __name__ == "__main__":
    ...
    test_df = pd.read_csv('data/validation/joy-ratings-0to1.dev.gold.txt', sep='\t', header=0)
    ...
    checkpointer = callbacks.ModelCheckpoint(filepath="logs/joy/checkpoint-{epoch:02d}.hdf5", verbose=1, save_best_only=True, monitor='loss')
    csv_logger = CSVLogger('logs/joy/training_set_iranalysis1.csv',separator=',', append=False)
